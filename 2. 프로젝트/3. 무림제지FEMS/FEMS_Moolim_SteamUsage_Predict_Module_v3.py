...
def delete() :
    ...
    # delete 쿼리
    # 현재 테이블 내 데이터 전체 삭제하는 쿼리문
    sql = "delete from fems.ems_enrg_fcst_rslt "
    
    # 쿼리 실행
    cur.execute(sql)
    conn.commit()
            
    return print(cur.rowcount, "Deleted, table is empty")
