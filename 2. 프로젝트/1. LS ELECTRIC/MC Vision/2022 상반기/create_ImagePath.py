...
# ======================================================================================================================
## Blob Storage 정보
STORAGEACCOUNTNAME = 'cj01vision002'
STORAGEACCOUNTKEY = 'XwwdSCl+QHHT9pEQj6+Q7C2+3BixfGHdcvEnU6UU+psu19i2vBN5ep+4yFuidDsd/ucBg43Mli6zaa6xyosHtQ=='
CONTAINERNAME = 'mc-vision'
...
side_list = ['LINE', 'LOAD', 'RIGHT', 'LEFT', 'TOP', 'BARRIER', 'BOTTOM']
...
def set_structure(line, fpath_list):
    ...
    for fpath in fpath_list:
        fullpath = 'https://cj01vision002.blob.core.windows.net/mc-vision/' + fpath
        fname = fpath.split('/')[4]
...
for line in line_list:
    ...
    try:
        ...
        if fpath_list:
            ...
            result = result.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'SIDE', 'DEFT_TYP', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI', 'URL']]
