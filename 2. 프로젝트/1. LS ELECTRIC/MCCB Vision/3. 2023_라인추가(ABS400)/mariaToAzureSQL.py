...
def set_line(line, result2):
    ...
    # #400/800 2개 추가 (라인명 확인 필요)   
    # elif line == 'ABS400LINE' :
    #     result2['LINE'] = 'ABS400c'

    ## MS SQL 테이블의 필드 순서와 일치시켜주는 작업
    result2 = result2.loc[:, ['LINE', 'DD', 'HHMISS', 'SRAL_ID', 'POLE', 'AMP', 'BRAND', 'TYP', 'CLS',
                              'POS', 'RST', 'DEFT_TYP', 'DEFT_TYP_FF', 'X1CODI', 'Y1CODI', 'X2CODI', 'Y2CODI']]
...
# line_list = ['ABH125_1LINE', 'ABH250_1LINE', 'ABH125_2LINE', 'ABH250_2LINE', 'ABH250_2LINE']
